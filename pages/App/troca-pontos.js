    ...
    modalExchange.addEventListener('click', function() {
        ...
        if (currentPoints >= itemPrice) {
            historyItems.unshift({
                ...
                points: itemPrice,
                icon: currentItem.dataset.categories.includes('energy') ? 'bolt' : 
                      currentItem.dataset.categories.includes('transport') ? 'bus' : 
                      currentItem.dataset.categories.includes('food') ? 'utensils' : 'gift',
